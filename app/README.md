...
Placify is a React Native-based mobile app designed to help you find and track relevant places near you.

# How It Works

The app is designed around creating lists based on different categories to keep track of different places. For example, say I wanted to keep track of my favorite restaurants -- I would first create a new list, within the "Lists" tab called "Restaurants", then navigate to the "Places" tab to search for restaurants in the vicinity and add them to my "Restaurants" list. We'll go through the flow below --
 ...
 * Let's type in to the input bar and call our list "Favorite Restaurants"
...
# v2 Features
  ...
  * Redirect buttons to Google Maps or Uber for quick, preset trips
